...
| # | 任务 | 状态 | Blocked by |
|---|------|------|------------|
| 23 | [Todo 数据模型 + Drift schema（migration v3）](23-todo-data-model.md) | DONE (Codex, PR #42) | — |
...
| 29 | [详情：状态编辑（5 态面板）](29-todos-status-edit.md) | READY | 28 ✅ |
| 30 | [详情：优先级 + 截止日期编辑](30-todos-priority-due-edit.md) | READY | 28 ✅ |
